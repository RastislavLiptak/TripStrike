<?php
  ...
  if (!isset($_GET['section'])) {
    header("Location: ../browsers/?section=browsers");
  }
?>
<!DOCTYPE html>
<html>
  <head>
    ...
    <title><?php echo $wrd_browsers." - ".$title." Back Door"; ?></title>
  </head>
  <body>
    <?php
      ...
      <div id="content-wrp">
        <div id="content">
          <div id="content-title-wrp">
            <h1 id="content-title"><?php echo $wrd_browsers; ?></h1>
          </div>
            ...
            <div class="striped-chart-header">
              ...
              <div class="striped-chart-tools">
                <div class="table-filter-select-wrp">
                  <select class="table-filter-select" id="striped-chart-filter-type-browsers" onchange="browsersLoadData()">
                ...
                <div class="table-filter-select-wrp">
                  <select class="table-filter-select" id="striped-chart-filter-period-browsers" onchange="browsersLoadData()">
